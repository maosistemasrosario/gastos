var conceptosControllerModule = angular.module("conceptosControllerModule", [])

conceptosControllerModule.service("conceptoService", function($http) {
	var conceptoService = {};
...
app.controller("conceptosController", ["$scope", "$routeParams", "$location", "conceptoService", function($scope, $routeParams, $location, conceptoService) {
